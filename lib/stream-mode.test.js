...
const cases = [
  ...
  // Multichannel AAC must remux (downmix to stereo): Firefox can't decode
  // 5.1/7.1 AAC and blacks out the whole video element. Stereo stays direct.
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', audioChannels: 6 }, 'remux'],
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', audioChannels: 8 }, 'remux'],
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', audioChannels: 2 }, 'direct'],
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', audioChannels: 1 }, 'direct'],
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', audioChannels: 0 }, 'direct'],
  ...
  // 10-bit H.264 (High 10 profile) — browsers can't decode; force transcode
  [{ ext: '.mkv', codec: 'h264', audioCodec: 'ac3', pixFmt: 'yuv420p10le' }, 'transcode'],
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', pixFmt: 'yuv420p10le' }, 'transcode'],
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', pixFmt: 'yuv420p10be' }, 'transcode'],
  [{ ext: '.mkv', codec: 'h264', audioCodec: 'aac', pixFmt: 'p010le' }, 'transcode'],
  // 8-bit H.264 pix_fmt still takes normal paths
  [{ ext: '.mp4', codec: 'h264', audioCodec: 'aac', pixFmt: 'yuv420p' }, 'direct'],
  [{ ext: '.mkv', codec: 'h264', audioCodec: 'aac', pixFmt: 'yuv420p' }, 'remux'],
  // unknown
